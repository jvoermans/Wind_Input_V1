...
void print_firmware_config(void){
    ...
    SERIAL_USB->print(F("compiling hostname: ")); SERIAL_USB->print(F(STRINGIFY_CONTENT(COMPILING_HOST_NAME)));
    SERIAL_USB->print(F(" | username: ")); SERIAL_USB->println(F(STRINGIFY_CONTENT(COMPILING_USER_NAME)));
    delay(10);
